...
import { Breadcrumb, CrossLink, Figure, H1, H3, LI, P, UL } from '@/components/ui.jsx';
...
export default function Page({ go }) {
  return (
    <div>
      ...
      <H3 id="stone-soup"><CrossLink pageId="structure" anchor="stone-soup" go={go}>Stone Soup</CrossLink></H3>
    </div>
  );
}
