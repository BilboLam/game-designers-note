...
import { Blockquote, Breadcrumb, H1, H2, H4, InternalLink, P } from '@/components/ui.jsx';
...
export default function Page({ go }) {
  return (
    <div>
      ...
      <H2 id="modulate-difficulty">Modulate Difficulty</H2>
      ...
      <H2 id="oscillate-difficulty">Oscillate Difficulty</H2>
