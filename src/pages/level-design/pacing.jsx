...
export default function Page({ go }) {
  return (
    <div>
      ...
      <H2 id="circulation"><InternalLink id="circulation" go={go}>Circulation</InternalLink></H2>
      <P>How players move through space.</P>
      <H2 id="game-beat"><InternalLink id="game-beat" go={go}>Game Beat</InternalLink></H2>
