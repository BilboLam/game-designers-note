...
import { Blockquote, Breadcrumb, Callout, CrossLink, ExtLink, H1, H3, P } from '@/components/ui.jsx';
...
export default function Page({ go }) {
  return (
    <div>
      ...
      <H3 id="dont-let-finding-rewards-be-a-task"><CrossLink pageId="rewarding-exploration" anchor="dont-let-finding-rewards-be-a-task" go={go}>Don't let finding rewards be a task</CrossLink></H3>
