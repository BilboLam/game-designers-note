...
export default function Page({ go }) {
  return (
    <div>
      ...
      <H2 id="level-elements"><InternalLink id="level-elements" go={go}>Level Elements</InternalLink></H2>
      <P>The smallest functional pieces in a level.</P>
      <H2 id="layout-patterns"><InternalLink id="layout-patterns" go={go}>Layout Patterns</InternalLink></H2>
