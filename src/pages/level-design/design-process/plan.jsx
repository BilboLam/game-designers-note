...
import { Annotation, Blockquote, Breadcrumb, CheckItem, CheckList, CrossLink, ExtLink, H1, H2, P } from '@/components/ui.jsx';
...
export default function Page({ go }) {
  return (
    <div>
      ...
      <H2 id="minimal-checklists">Minimal Checklists</H2>
      <CheckList>
      ...
      <H2 id="basic-checklists">Basic Checklists</H2>
      <CheckList>
      ...
      <H2 id="team-checklists">Team Checklists</H2>
